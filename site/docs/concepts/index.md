...
# Common concepts and terminology used by Egeria
...
- [Cohort Registry](./concepts/cohort-registry)
- [Cohort Registry Store Connector](./concepts/cohort-registry-store-connector)
...
- [Open Metadata Conformance Suite](./guides/cts/overview)
...
- [Qualified Name](./concepts/referenceable)
...
- [User Roles](./concepts/person-role)
- [Users](user-identity)
...
- [Virtual Connector](./concepts/connector)
...
- [Zones (Governance)](./concepts/governance-zone)
